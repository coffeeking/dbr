...
class MainWindow(wx.Frame):
    ...
    def InitUI(self):
        ...
        goToMenu=wx.Menu()
        goToMenu.Append(100, 'go to page')
        goToMenu.AppendSeparator()
        goToMenu.Append(101, 'go to chapter')
        helpMenu=wx.Menu()
        ...
        menubar.Append(goToMenu, '&go to')
        menubar.Append(helpMenu, '&help')
        self.SetMenuBar(menubar)
        ListBox=wx.ListBox(self)
        ListBox.SetLabel('books list')
        txtBox = wx.TextCtrl(self)
        txtBox.SetName('book contents')
